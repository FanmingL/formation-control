...
BOOL USBD_ReqGetStatus (void) {//__inline 
  U32 n, m;
...
BOOL USBD_ReqSetClrFeature (U32 sc) {//__inline 
  U32 n, m;
...
BOOL USBD_ReqGetDescriptor (void) {//__inline 
  U8  *pD;
  U32  len, n;
...
BOOL USBD_ReqGetConfiguration (void) {//__inline 
...
BOOL USBD_ReqSetConfiguration (void) {//__inline 
...
BOOL USBD_ReqGetInterface (void) {//__inline 
...
BOOL USBD_ReqSetInterface (void) {//__inline 

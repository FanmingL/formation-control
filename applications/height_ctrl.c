...
void h_pid_init()
{
	...
	h_height_arg.ki = 1.0f *pid_setup.groups.hc_height.ki;				//积分系数
...
float exp_height_l=480.0f; //expect height is 400mm;
...
////////////////////////////////////////////////////////////////////////////
	...
	if (set_speed>0)
		set_speed = PID_calculate( T,            //周期
														0,				//前馈
														exp_height_l,				//期望值（设定值）
														//CH[2]*1.5f,		//期望值     油门控制高度
														hc_value.fusion_height,			//反馈值
...
//	if(en < 0.1f)		//en =1 commentted by Mr.Lin
//	{
...
/////////////////////////////////////////////////////////////////////////////////	
	float acc_i_lim;
	acc_i_lim = safe_div(150,h_acc_arg.ki,0);	//150/0.02=7500
	...
	//起飞油门
	if(h_acc_val.err_i > (acc_i_lim * 0.2f))	//7500/5=1500
	{

	...
	if(TIM3->SR & TIM_IT_CC1) 
	{
		...
		else
		{
			...
			if(temp_cnt1_2>=temp_cnt1)
				Rc_Pwm_In[0] = temp_cnt1_2-temp_cnt1 - 17;
			else
				Rc_Pwm_In[0] = 0xffff-temp_cnt1+temp_cnt1_2+1 - 17;
		}
	}
	if(TIM3->SR & TIM_IT_CC2) 
	{
		...
		else
		{
			...
			if(temp_cnt2_2>=temp_cnt2)
				Rc_Pwm_In[1] = temp_cnt2_2-temp_cnt2 - 2;
			else
				Rc_Pwm_In[1] = 0xffff-temp_cnt2+temp_cnt2_2 - 2;
		}
	}
	if(TIM3->SR & TIM_IT_CC3) 
	{
		...
		else
		{
			...
			if(temp_cnt3_2>=temp_cnt3)
				Rc_Pwm_In[2] = temp_cnt3_2-temp_cnt3 - 30;
			else
				Rc_Pwm_In[2] = 0xffff-temp_cnt3+temp_cnt3_2+1 - 30;
		}
	}
